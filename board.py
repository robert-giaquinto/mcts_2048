...
class Board(object):
	...
	def canMove(self):
		"""
		test if any moves are possible
		"""
		if not self.filled():
			return True
	...
	def get_valid_moves(self):
		rval = []
		if self.is_move_valid(Board.UP):
			rval.append(1)
		if self.is_move_valid(Board.DOWN):
			rval.append(2)
		if self.is_move_valid(Board.LEFT):
			rval.append(3)
		if self.is_move_valid(Board.RIGHT):
			rval.append(4)
		return rval
